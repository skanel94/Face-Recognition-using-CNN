# execution command: python inception_net.py
...
output = InceptionV3_base.output
output = GlobalAveragePooling2D()(output)
# Add a fully-connected layer
output = Dense(1024, activation='relu')(output)
# Add a logistic layer -- we have 10 classes
output = Dense(10, activation='softmax', name='predictions')(output)
# Update the weight that are added
model = Model(input = InceptionV3_base.input, output = output)
